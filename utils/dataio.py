...
class ReachabilityDataset(Dataset):
    ...
    def generate_MPC_dataset(self, T, t, style="random"):
        ...
        _, _, MPC_inputs, MPC_values = self.mpc.get_batch_data(
            MPC_states.cuda(), T, self.policy, t=t
        ...
        for i in tqdm(range(self.num_MPC_batches - 1)):
            ...
            if self.mpc.style == "direct":
                ...
                t_max = (
                    random.randint(1, int(T / self.MPC_dt / self.mpc.receding_horizon))
                    * self.mpc.receding_horizon
                    * self.MPC_dt
                )
                # t_max=T*1.0
            else:
            ...
            # t_max=self.tMax
            _, _, MPC_inputs_, MPC_values_ = self.mpc.get_batch_data(MPC_states.to(device), t_max, self.policy, t=t)
